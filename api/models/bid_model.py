...
class BidModel():
    def __init__(self, tender, client, bid_date, alias=None, bid_folder_url=None, feedback=None, failed=None, was_successful=False, success=[],status=Status.IN_PROGRESS):
        self._id = uuid4()
        self.tender = tender
        self.client = client
        self.alias = alias
